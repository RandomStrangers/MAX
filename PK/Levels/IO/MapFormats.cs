...
namespace PattyKaki.Levels.IO
{
    ...
    public abstract class IMapImporter
    {
        ...
        public static IMapImporter defaultImporter = new MapImporter();
    ...
    public abstract class IMapExporter
    {
        ...
        {
            new LvlExporter(), new MapExporter(), new McfExporter()
        };
        public static IMapExporter defaultExporter = new MapExporter();
        ...
        public static void Encode(string path, Level lvl)
        {
            ...
            Logger.Log(LogType.Debug, "P: {0}", p);
            Logger.Log(LogType.Debug, "Path: {0}", path);
