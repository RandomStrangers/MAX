...
namespace PattyKaki 
{
    ...
    public sealed class ServerConfig : EnvConfig 
    {
        ...
        [ConfigNByte("max-players", "Server", 16, 1, Server.MAX_PLAYERS)]
        public byte MaxPlayers = 16;
        [ConfigNByte("max-guests", "Server", 14, 1, Server.MAX_PLAYERS)]
        public byte MaxGuests = 14;
        ...
        [ConfigString("irc-nick", "IRC bot", "PK")]
        public string IRCNick = "PK";
        ...
        [ConfigString("irc-command-prefix", "IRC bot", ".pk", true)]
        public string IRCCommandPrefix = ".pk";
        ...
        [ConfigString("pk-state", "Chat", "&dPatty&eKaki")]
        public string PKState = "&dPatty&eKaki";
        ...
        [ConfigInt("cmd-spam-count", "Spam control", 25, 0, int.MaxValue)]
