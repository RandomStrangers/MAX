...
namespace Flames.Modules.Relay.Hummus
{
    ...
    public sealed class HummusApiClient : AsyncWorker<HummusApiMessage>
    {
        public string Token;
        const string host = "https://hummus.sys42.net/api/v6";

        HummusApiMessage GetNextRequest()
        {
        ...
        protected override string ThreadName { get { return "Hummus-ApiClient"; } }
        ...
        static void LogError(Exception ex, HummusApiMessage msg)
        {
    ...
    public sealed class HummusBot : RelayBot
    {
        HummusApiClient api;
        HummusWebsocket socket;
        HummusSession session;
        string botUserID;
        ...
        TextFile replacementsFile = new TextFile("text/hummus/replacements.txt",
        ...
        void HandlePlayerConnect(Player p) { UpdateHummusStatus(); }
        void HandlePlayerDisconnect(Player p, string reason) { UpdateHummusStatus(); }
    ...
    public sealed class HummusConfig
    {
        ...
        public void Save()
        {
            ...
            using (StreamWriter w = new StreamWriter(PROPS_PATH))
            {
                ...
                w.WriteLine("# See " + Updater.SourceURL + "/wiki/Hummus-relay-bot/");
                w.WriteLine();
    ...
    public sealed class HummusPlugin : Plugin
    {
    ...
    public sealed class CmdHummusBot : RelayBotCmd
    {
        public override string name { get { return "HummusBot"; } }
        protected override RelayBot Bot { get { return HummusPlugin.Bot; } }
    }

    public sealed class CmdHummusControllers : BotControllersCmd
    {
        public override string name { get { return "HummusControllers"; } }
        protected override RelayBot Bot { get { return HummusPlugin.Bot; } }
    }
    public sealed class HummusSession
    {
    ...
    public sealed class HummusWebsocket : ClientWebSocket
    {
