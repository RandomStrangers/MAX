...
namespace PluginRelayLogger
{
    public sealed class RelayLoggerPlugin : Plugin
    {
        public override string name { get { return "RelayLogger2"; } }
        ...
        void OnMessage(RelayBot bot, string channel, RelayUser user, string message, ref bool cancel)
        {
            ...
            foreach (Route route in routes)
            {
                ...
                if (msg.CaselessStarts("**Onedez**")) continue;
  				//Logger.Log(LogType.Debug, msg);
  				route.dstBot.SendMessage("1181362607605678192", msg);
            }
        }
        ...
        const string ROUTES_FILE = "text/harmony_server.txt";
