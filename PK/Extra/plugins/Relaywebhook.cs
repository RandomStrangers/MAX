...
namespace Core {
	public class RelayWebhook : Plugin {
        
        public override string creator { get { return ""; } }
        public override string name { get { return "RelayWebhook"; } }
        ...
        static void RelayLog(LogType type, string relaymessage) {
        ...
        public static void sendRequest(string URL, string msg) {
            ...
            Logger.LogHandler -= RelayLog;
Logger.Log(LogType.SystemActivity, "Relay webhook unloaded!");
        }
    }
