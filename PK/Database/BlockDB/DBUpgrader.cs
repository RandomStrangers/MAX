...
namespace PattyKaki.DB 
{
    ...
    {     
        ...
        public static string[] CompactMessages = new string[] {
            ...
            "   a) doing VACUUM on the database (note that this will create a temp file as big as PattyKaki.db)",
            "   b) doing /server backup litedb, shutting down the server, deleting PattyKaki.db, then finally running /server import SQL",
        };
        ...
        public static void Unlock() {
            ...
            Player.PK.MessageLines(CompactMessages);
