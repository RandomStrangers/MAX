...
namespace PattyKaki.SQL 
{
    public sealed class SQLiteBackend : IDatabaseBackend 
    {
        ...
        public override void LoadDependencies() {
            ...
            // sqlite3.dll is the .DLL that PattyKaki will actually load on Windows
            try {
    ...
    sealed class PKSQLiteConnection : SQLiteConnection 
    {
        protected override bool ConnectionPooling { get { return Server.Config.DatabasePooling; } }
        protected override string DBPath { get { return "PattyKaki.db"; } }
    }
}