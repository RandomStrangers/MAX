...
namespace MAX.Blocks
{
    ...
    public static class BlockOptions
    {
        ...
        public static void SetPortal(Player p, BlockProps[] s, ushort b, string v) { ToggleBehaviour(p, s, b, "a portal", ref s[b].IsPortal); }
        public static void SetMB(Player p, BlockProps[] s, ushort b, string v) { ToggleBehaviour(p, s, b, "a message block", ref s[b].IsMessageBlock); }
        public static void SetRails(Player p, BlockProps[] s, ushort b, string v) { Toggle(p, s, b, "train rails", ref s[b].IsRails); }
        public static void SetWater(Player p, BlockProps[] s, ushort b, string v) { Toggle(p, s, b, "killed by water", ref s[b].WaterKills); }
        public static void SetLava(Player p, BlockProps[] s, ushort b, string v) { Toggle(p, s, b, "killed by lava", ref s[b].LavaKills); }
        public static void SetDoor(Player p, BlockProps[] s, ushort b, string v) { ToggleBehaviour(p, s, b, "a door", ref s[b].IsDoor); }
        public static void SetTDoor(Player p, BlockProps[] s, ushort b, string v) { ToggleBehaviour(p, s, b, "a tDoor", ref s[b].IsTDoor); }
        public static void SetKiller(Player p, BlockProps[] s, ushort b, string v) { Toggle(p, s, b, "a killer block", ref s[b].KillerBlock); }
        public static void SetOPBlock(Player p, BlockProps[] s, ushort b, string v) { Toggle(p, s, b, "an OP block", ref s[b].OPBlock); }
        public static void SetDrown(Player p, BlockProps[] s, ushort b, string v) { Toggle(p, s, b, "drowns players", ref s[b].Drownable); }
        public static void SetGrass(Player p, BlockProps[] s, ushort b, string v) { SetBlock(p, s, b, v, "Grass form", ref s[b].GrassBlock); }
        public static void SetDirt(Player p, BlockProps[] s, ushort b, string v) { SetBlock(p, s, b, v, "Dirt form", ref s[b].DirtBlock); }
        public static void SetODoor(Player p, BlockProps[] s, ushort b, string v) { SetBlock(p, s, b, v, "oDoor form", ref s[b].oDoorBlock); }
        ...
        public static void SetAI(Player p, BlockProps[] scope, ushort block, string msg)
        {
            ...
            if (!OrderParser.GetEnum(p, msg, "Animal AI", ref ai)) return;
        ...
        public static void SetStackId(Player p, BlockProps[] scope, ushort block, string msg)
        {
            ...
            {
                if (!OrderParser.GetBlock(p, msg, out stackBlock)) return;
            }
                             ...
                             string msg, string type, ref ushort target)
        {
            ...
            {
                if (!OrderParser.GetBlockIfAllowed(p, msg, "use", out ushort other)) return;
