...
{   
    ...
    {    
        ...
        public override void Parse(string prop, string value) {
            ...
            LevelPermission perm = Group.ParsePermOrName(args[0], LevelPermission.MAX);
            if (perm == LevelPermission.MAX) return;
        ...
        public override void OnPurchase(Player p, string args) {
            ...
            Order.Find("SetRank").Use(Player.MAX, p.name + " " + rank.Name);
