        ...
        public bool VerifyNick(string channel, string userNick, ref string error, ref bool foundAtAll)
        {
            ...
            if (verify == IRCControllerVerify.HalfOp)
            {
                ...
                { // + prefix is 'voiced user'
                    error = "You must be at least a half-op on the channel to use orders from IRC."; return false;
                }
                return true;
            }
            else
            {
                ...
                error = "You must have joined the opchannel to use orders from IRC."; return false;
            }
        }
    }
