...
namespace MAX.Relay.IRC
{
    ...
    public class IRCBot : RelayBot
    {
        ...
        public override bool CheckController(string userID, ref string error)
        {
            ...
            {
                if (nicks.VerifyNick(chan, userID, ref error, ref foundAtAll))
                {
                    return true;
                }
            }
        ...
        {
            if (!notice.CaselessStarts("You are now identified"))
            {
                return;
            }
            JoinChannels();
    ...
    public class IRCNickList
    {
        ...
        public List<string> GetNicks(string channel)
        {
            ...
            {
                if (chan.Key.CaselessEq(channel))
                {
                    return chan.Value;
                }
            }
