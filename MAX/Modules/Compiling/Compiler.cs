...
namespace MAX.Compiling
{
    ...
    public class ICompiler
    {
        ...
        public virtual string OrderSkeleton { get; }
        /// <summary> Returns source code for an example Addon </summary>
        public virtual string AddonSkeleton { get; }
        ...
        {
            return FormatSource(AddonSkeleton, addon, creator, Server.InternalVersion);
        }
        ...
        public virtual ICompilerErrors DoCompile(string[] srcPaths, string dstPath)
        {
            return null;
        }
