...
namespace MAX.Orders.World {
    public sealed class OrdMap : Order2 {
        ...
        public override OrderPerm[] ExtraPerms {
            get { return new[] { new OrderPerm(LevelPermission.Operator, "can edit map options"),
                    new OrderPerm(LevelPermission.Admin, "can set realm owners") }; }
        }
        public override OrderDesignation[] Designations {
            get { return new[] { new OrderDesignation("ps", LevelOptions.Speed),
                    new OrderDesignation("AllowGuns", "{args} " + LevelOptions.Guns) }; }
        }
