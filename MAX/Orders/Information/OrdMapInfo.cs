...
{
    public sealed class OrdMapInfo : Order2 
    {
        ...
        public override OrderDesignation[] Designations {
            get { return new[] { new OrderDesignation("WInfo"), new OrderDesignation("WorldInfo") }; }
        }
        ...
        public void ShowNormal(Player p, MapInfo data, LevelConfig cfg) {
            ...
            string physicsState = OrdPhysics.states[cfg.Physics];
