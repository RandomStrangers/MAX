...
namespace MAX.Orders {
    public abstract class EntityPropertyOrd : Order2 {

        public void UseBotOrOnline(Player p, OrderData data, string message, string type) {
        ...
        public void UseBotOrPlayer(Player p, OrderData data, string message, string type) {
            if (message.CaselessStarts("bot ")) {
                UseBot(p,    data, message, type);
            } else {
        ...
        public void UseBot(Player p, OrderData data, string message, string type) {
        ...
        public void UseOnline(Player p, OrderData data, string message, string type) {
        ...
        public void UsePlayer(Player p, OrderData data, string message, string type) {
            if (message.Length == 0) { Help(p); return; }
            string[] args = message.SplitSpaces(2);
