...
namespace MAX.Orders.CPE 
{
    public static class CustomBlockOrder 
    {
        ...
        public static void Execute(Player p, string message, OrderData data, bool global, string ord) {
            ...
            switch (parts[0]) { // TODO IsCreateOrder
                case "add":
                case "create":
        ...
        public static BlockRaw GetFallback(Player p, string value) {
            BlockID block;
            if (!OrderParser.GetBlock(p, value, out block)) return Block.Invalid;
        ...
        public static bool CheckRawBlocks(Player p, string arg, BlockDefinitionsArgs args,
            ...
            if (OrderParser.IsRawBlockRange(arg, out bits)) {
    ...
    public sealed class OrdGlobalBlock : Order2 {
    ...
    public sealed class OrdLevelBlock : Order2 {
