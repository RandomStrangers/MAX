...
{
    public class OrdModel : EntityPropertyOrd 
    {
        ...
        public override OrderPerm[] ExtraPerms {
            get { return new[] { new OrderPerm(LevelPermission.Operator, "can change the model of others"),
                    new OrderPerm(LevelPermission.Operator, "can change the model of bots") }; }
        }
        public override OrderDesignation[] Designations {
            get { return new[] { new OrderDesignation("XModel", "-own") }; }
        }
