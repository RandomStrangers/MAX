...
namespace MAX.Orders.Misc {
    public sealed class OrdSummon : Order2 {
        ...
        public override OrderDesignation[] Designations {
            get { return new[] { new OrderDesignation("Fetch"), new OrderDesignation("Bring"), new OrderDesignation("BringAll", "all") }; }
        }
        public override OrderPerm[] ExtraPerms {
            get { return new[] { new OrderPerm(LevelPermission.Operator, "can summon all players") }; }
        }
        ...
        public static void SummonPlayer(Player p, string message, OrderData data) {
