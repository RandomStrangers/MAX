...
{
    public abstract class ItemPermsOrd : Order
    {
        public override string Type { get { return OrderTypes.Moderation; } }
        public override LevelPermission DefaultRank { get { return LevelPermission.Operator; } }

        public void SetPerms(Player p, string[] args, OrderData data, ItemPerms perms, string type)
        {
        ...
        public virtual void UpdatePerms(ItemPerms perms, Player p, string msg)
        {
        }

        public static Group GetGroup(Player p, OrderData data, string grpName)
        {
