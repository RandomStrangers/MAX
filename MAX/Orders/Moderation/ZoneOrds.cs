...
namespace MAX.Orders.Moderation {
    public sealed class OrdZone : Order2 {
        ...
        public override OrderDesignation[] Designations {
            get { return new[] { new OrderDesignation("ZRemove", "del"), new OrderDesignation("ZDelete", "del"),
    ...
    public sealed class OrdZoneTest : Order2 {
    ...
    public sealed class OrdZoneList : Order2 {
    ...
    public sealed class OrdZoneMark : Order2 {
