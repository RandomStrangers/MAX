...
namespace MAX.Orders.Maintenance {
    public sealed class OrdPlayerEdit : Order2 {
        ...
        public override OrderDesignation[] Designations {
            get { return new [] { new OrderDesignation("SetInfo") }; }
        }
        ...
        static void SetTimespan(Player p, string[] args, string column, Player who, Action<TimeSpan> setter) {
            if (args.Length < 3) {
                ...
                p.Message(OrderParser.TimespanHelp, "set time spent to");
                return;
            }
            
            TimeSpan span = TimeSpan.Zero;
            if (!OrderParser.GetTimespan(p, args[2], ref span, "set time spent to", "m")) return;
        ...
        static void SetInteger(Player p, string[] args, string column, int max, Player who,
            ...
            int value = 0;
            if (!OrderParser.GetInt(p, args[2], "Amount", ref value, 0, max)) return;
