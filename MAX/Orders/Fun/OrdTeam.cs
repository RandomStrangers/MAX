...
namespace MAX.Orders.Fun {
    public sealed class OrdTeam : Order2 {        
        ...
        public override OrderPerm[] ExtraPerms {
            get { return new[] { new OrderPerm(LevelPermission.AdvBuilder, "can create teams") }; }
        }
        ...
        public void HandleCreate(Player p, string[] args, OrderData data) {
