...
namespace MAX.Network
{
    ...
    public class BaseWebSocket : INetSocket, INetProtocol
    {
        ...
        public virtual void OnGotAllHeaders()
        {
        }
        public virtual void OnGotHeader(string name, string value)
        {
        }
    ...
    public class ClientWebSocket : BaseWebSocket
    {
        public string path = "/";
        public string verKey;
