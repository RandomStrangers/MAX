...
namespace MAX
{
    ...
    public static class MultiPageOutput
    {
        ...
        public static void Output<T>(Player p, IList<T> items, StringFormatter<T> formatter,
                                     string ord, string type, string modifier, bool lines)
        {
            ...
            {
                OutputPage(p, items, formatter, ord, type, 1, lines);
            ...
            {
                OutputPage(p, items, formatter, ord, type, page, lines);
            }
        }

        public static void OutputPage<T>(Player p, IList<T> items, StringFormatter<T> formatter,
                                  string ord, string type, int start, bool lines)
        {
            int perPage = lines ? 8 : 30;
