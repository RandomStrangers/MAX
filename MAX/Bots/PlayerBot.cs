...
namespace MAX
{
    ...
    public class PlayerBot : Entity
    {
        ...
        public static bool CanEditAny(Player p)
        {
            ...
            ItemPerms perms = OrderExtraPerms.Find("Bot", 1) ?? new ItemPerms(LevelPermission.Operator);
        ...
        public static int RemoveBotsOwnedBy(string ownerName, Level lvl, bool save)
        {
            PlayerBot[] bots = lvl.Bots.Items;
            int removedCount = 0;
            for (int i = 0; i < bots.Length; i++)
        ...
        public static unsafe byte NextFreeId(PlayerBot bot)
        {
        ...
        public static unsafe void UpdatePositions(Level lvl)
        {
        ...
        public void DisplayInfo(Player p)
        {
            ...
            ItemPerms perms = OrderExtraPerms.Find("About", 1) ?? new ItemPerms(LevelPermission.AdvBuilder);
