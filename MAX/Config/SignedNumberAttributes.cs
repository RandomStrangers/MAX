...
{
    public class ConfigSignedIntegerAttribute : ConfigAttribute
    {
    ...
    public class ConfigSByteAttribute : ConfigSignedIntegerAttribute
    {
        ...
        {
            return (sbyte)ParseInteger(raw, 0, sbyte.MinValue, sbyte.MaxValue);
        }
    }
    public class ConfigShortAttribute : ConfigSignedIntegerAttribute
    {
        ...
        public override object Parse(string raw)
        {
            return (short)ParseInteger(raw, 0, short.MinValue, short.MaxValue);
        }
    }
}