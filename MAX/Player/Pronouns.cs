...
namespace MAX
{
    ...
    {
        public const string CONFIG_FILE = "props/pronouns.properties";
        public const string PLAYER_PATH = "text/pronouns/";
        public static object locker = new object();
        public static List<Pronouns> Loaded = new List<Pronouns>();
        ...
        public static string PlayerPath(string playerName)
        {
            return PLAYER_PATH + playerName + ".txt";
        }
        /// <summary>
        ...
        public static List<Pronouns> GetFor(string playerName)
        {
            ...
            try
            {
                ...
                data = data.Trim();
                if (data.Length == 0) return new List<Pronouns>
                {
                    Default
                };
        ...
        /// have, has
        /// </summary>
        public string PresentPerfectVerb;
        public Pronouns(string name, string subject, string @object, string reflexive, bool plural)
        {
            Name = name;
            Subject = subject;
            Object = @object;
