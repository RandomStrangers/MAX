...
namespace MAX
{
    public partial class Player : IDisposable
    {
        public bool ProcessLogin(string user, string mppass)
        {
            ...
            if (user.Length < 1 || user.Length > byte.MaxValue)
            {
                Leave(null, "Usernames must be between 1 and " + byte.MaxValue + " characters", true); return false;
            }
        ...
        public void CompleteLoginProcess()
        {
            ...
            {
                Message("&9You must read the &c/Rules &9and &c/Agree &9to them before you can Build and use orders!");
                agreed = false;
            }
        ...
        public static unsafe byte NextFreeId()
        {
