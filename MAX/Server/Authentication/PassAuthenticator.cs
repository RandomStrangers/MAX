...
namespace MAX.Authentication
{
    ...
    public class PassAuthenticator
    {
        ...
        public virtual bool HasPassword(string name)
        {
            return false;
        }

        /// <summary> Sets the stored password for the given player </summary>
        public virtual void StorePassword(string name, string password)
        {
        }
        ...
        public virtual bool ResetPassword(string name)
        {
            return false;
        }
        ...
        public virtual bool VerifyPassword(string name, string password)
        {
            return false;
        }
        ...
        public static bool VerifyPassword(Player p, string password)
        {
            ...
            p.Message("You are now &averified &Sand can now &ause orders, modify blocks, and chat.");
            p.verifiedPass = true;
            p.Unverified = false;
            return true;
        }
