...
namespace MAX.Levels.IO
{
    ...
    public unsafe class FLvlImporter : IMapImporter
    {
        public override string Extension { get { return ".flvl"; } }
        public override string Description { get { return "Flames map"; } }
        ...
        public static Vec3U16 ReadHeader(Stream gs, byte[] header)
        {
            ...
            if (signature != 1874)
                throw new InvalidDataException("Invalid .flvl map signature");
