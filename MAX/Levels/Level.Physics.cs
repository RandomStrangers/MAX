...
namespace MAX
{
    ...
    public partial class Level : IDisposable
    {
        ...
        public void AddCheck(int index, bool overRide, PhysicsArgs data)
        {
            ...
            {
                Logger.Log(LogType.Warning, "Warning-PhysicsCheck");
                Check NewCheck = new Check
                {
                    Index = index,
                    data = data
                };
                ListCheck.Add(NewCheck);    //Lousy back up plan
            }
        }
        ...
        public bool AddUpdate(int index, ushort block, PhysicsArgs data, bool overRide = false)
        {
            ...
            catch
            {
                ...
                ListUpdate.Add(NewUpdate); //Lousy back up plan
                return false;
            }
        }
