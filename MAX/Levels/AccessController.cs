...
namespace MAX
{
    ...
    public abstract class AccessController
    {
        ...
        public AccessResult Check(string name, LevelPermission rank)
        {
            ...
            if (rank > Max && MaxOrd != null && !OrderExtraPerms.Find(MaxOrd, 1).UsableBy(rank))
            {
    ...
    public class LevelAccessController : AccessController
    {
        ...
        public override string MaxOrd { get { return isVisit ? "PerVisit" : "PerBuild"; } }
