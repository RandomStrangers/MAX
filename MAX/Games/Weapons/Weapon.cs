...
namespace MAX.Games
{
    ...
    public class Weapon
    {
        ...
        public virtual void OnActivated(Vec3F32 dir, ushort block)
        {
        }
        ...
        public static void BlockChangingCallback(Player p, ushort x, ushort y, ushort z, ushort block, bool placing, ref bool cancel)
        {
            ...
            if (!OrderParser.IsBlockAllowed(p, "use", block)) return;
                                        ...
                                        ushort x, ushort y, ushort z, TargetBlockFace face)
        {
            ...
            if (!OrderParser.IsBlockAllowed(p, "use", held)) return;
