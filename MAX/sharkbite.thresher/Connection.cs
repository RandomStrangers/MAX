...
namespace Sharkbite.Irc
{
    ...
    public class Connection
    {
        ...
        public Stream MakeDataStream()
        {
            ...
            return MAX.Network.HttpUtil.WrapSSLStream(raw, Hostname);
        }
        ...
        public void Connect()
        {
            lock (this)
            {
                ...
                // NOTE: The following two orders may fail if
        ...
        /// <summary> Test if the message contains CTCP orders. </summary>
        ...
        public void SendOrder(string order)
        {
            try
            {
                lock (sendLock) { writer.WriteLine(order); }
            }
            catch
            {
            }
        ...
        public void SendUser()
        {
            ...
            SendOrder("USER " + UserName + " 4 * :" + RealName);
        }
        ...
        public void SendJoin(string channel, string password)
        {
            ...
            SendOrder("JOIN " + channel + " " + password);
        }
        ...
        public void SendMessage(string target, string message)
        {
            ...
            lock (sendLock)
            {
                ...
                if (message.Length > max)
                {
                    ...
                    {
                        SendOrder("PRIVMSG " + target + " :" + part);
                    }
                }
                else
                {
                    SendOrder("PRIVMSG " + target + " :" + message);
                }
            }
        }
        ...
        public void ParseOrder(string[] tokens)
        {
